...
back either free text or a validated :class:`~proper_search.models.Description`.
Everything about *how many* calls to make and *what* to ask lives in
:mod:`proper_search.vision.strategies`, so adding a provider never means
...
class VisionProvider(ABC):
    ...
    async def describe(self, request: VisionRequest) -> tuple[Description, UsageRecord]:
        ...
        :class:`~proper_search.errors.ProviderRefusal` when the model declines,
