...
class ProperSearchError(Exception):
...
class RetryableError(ProperSearchError):
...
class TerminalError(ProperSearchError):
...
class ConfigError(ProperSearchError):
...
class ProviderError(ProperSearchError):
...
class StorageError(ProperSearchError):
