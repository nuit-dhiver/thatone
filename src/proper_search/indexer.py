...
from .errors import MediaError, MediaTooLargeError, ProperSearchError, TerminalError
...
class Indexer:
    ...
    async def describe(self, media_id: str) -> UsageRecord:
        ...
        if self.vision is None:
            raise ProperSearchError("no vision provider configured")
    ...
    async def embed(self, media_id: str) -> int:
        ...
        if self.embedder is None:
            raise ProperSearchError("no embedding provider configured")
