...
:class:`ProperSearch` owns the wiring — storage, providers, indexer, worker,
...
from .errors import ConfigError, ProperSearchError, TerminalError
...
class ProperSearch:
    ...
    @classmethod
    def open(cls, settings: Settings | None = None) -> ProperSearch:
    ...
    async def index(
        ...
        *,
        ...
        for source_type, target in refs:
            ...
            except ProperSearchError as exc:
    ...
    async def __aenter__(self) -> ProperSearch:
        return self
